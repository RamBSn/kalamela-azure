...
class EventConfig(db.Model):
    ...
    # PDF certificate font (built-in name or TTF file path)
    cert_font = db.Column(db.String(500), default='Times-Roman')
    # Social certificate template
    social_cert_bg_image    = db.Column(db.String(300), nullable=True)
    social_cert_font        = db.Column(db.String(500), nullable=True)
    social_cert_pos_colour  = db.Column(db.String(10), default='#d4af37')
    social_cert_name_colour = db.Column(db.String(10), default='#ffffff')
    ...
    social_cert_show_footer = db.Column(db.Boolean, default=True)
    ...
    social_cert_item_y_pct = db.Column(db.Float, default=65.0)
